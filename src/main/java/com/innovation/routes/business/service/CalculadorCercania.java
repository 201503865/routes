...
public class CalculadorCercania {
    ...
    public static DistanciaTiempo calcularDistanciaTiempo(double latitud1, double longitud1, double latitud2, double longitud2) {
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            if (routes.length() > 0) {
                ...
                return new DistanciaTiempo(convertirDistanciaKm(distancia),duracion);
            } else {
