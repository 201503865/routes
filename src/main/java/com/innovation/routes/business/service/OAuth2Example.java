...
public class OAuth2Example {
    private static final String APPLICATION_NAME = "Tu Aplicacion";
    ...
    /*public static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException, GeneralSecurityException {
        InputStream in = OAuth2Example.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        ...
        System.out.println("Credentials successfully obtained: " + credential);
    }*/
}
